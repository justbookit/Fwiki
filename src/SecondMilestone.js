            ...
            <div>
                ...
                <div className="blue-container size-16 white">
                    ...
                    <div className="section-content">
                        ...
                        <p>After we faced the problem we start a questionnaire, available here <a className="link-container" href="https://goo.gl/forms/pzhMKOv5r2BT0H0x2">here</a>,  to see if the problem we face is met but other people as well. The results, which are available here <a className="link-container" href="https://docs.google.com/spreadsheets/d/1NOvkivkK5_o1y0PM-vbE3euwSA8YsIbZSKqzfnBTvVA/edit#gid=948342061">here</a> , showed that most of the person which completed the questionnaire, 97 out of 104, said that they lose too much time at the railway tickets offices. When we asked them why they don’t purchase tickets online, 82 out of 104 are given a discount which is not available in online purchase.</p>
                ...
                <div className="blue-container size-16 white">
                    ...
                    <div className="section-content">
                        ...
                        <p>The questions are available here  <a className="link-container" href="https://goo.gl/forms/pzhMKOv5r2BT0H0x2">here</a> and we wanted to see:</p>
                        <ul>
